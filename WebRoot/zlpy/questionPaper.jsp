...
<html>
  <head>
	...
	<script type="text/javascript">
		...
		function onQuery(_i,_questionPaperName,_indexId){
			html=[];
			if(_indexId<1){
				alert("当前已是首页");
				return false;
			...
			$.ajax({
				async:true,
				url:'goods/questionPaper.action?poolId='+_i+'&questionPaperName='+_questionPaperName+'&pageIndex='+_indexId,
				type:'post',
				data:1,
				dataType:'json',
    ...
    <div class="ipr-index-mian" id="page">
      <div class="ipr-index-top">
        ...
        <ul style="display: none" id="ul">
          <li class="breakfix"><a href="{href}">{questionPaperName}</a></li>
        </ul>
      </div>
      <div  id="use2">
