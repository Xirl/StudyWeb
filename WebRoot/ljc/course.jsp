...
<link href="../jsp/ljc/css/homepage.css" rel="stylesheet" type="text/css" />

<!-- <script type="text/javascript" src="../jsp/ljc/js/cuf_run.js"></script> -->
<!-- <script type="text/javascript" src="../jsp/ljc/js/arial.js"></script>
<script type="text/javascript" src="../jsp/ljc/js/cuf_run.js"></script> -->
<script type="text/javascript" src="../jsp/ljc/js/jquery-1.8.3.js"></script>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article" >
          <h2><span>${name }</span></h2><div class="clr"></div>
          <c:forEach items="${dataList }" var="d">
          		<a href="../jsp/ljc/vedio.jsp?vedio=${d.filename}">${d.title }</a><br>
          </c:forEach>
        </div>
      </div>
      <div class="sidebar">
